...
privileged aspect BuddyController_Roo_Controller {
    ...
    void BuddyController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("buddy_dateofbirth_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
